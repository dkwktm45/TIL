...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    SecurityContextPersistenceFilter secureASTCustomizerFactory;
    ...
    public ServletListenerRegistrationBean<HttpSessionEventPublisher> httpsessionListener(){
        return new ServletListenerRegistrationBean<HttpSessionEventPublisher>(new HttpSessionEventPublisher() {
            ...
            public void sessionCreated(HttpSessionEvent event) {
                ...
                System.out.println("세션 생성 : " + LocalDateTime.now()
            ...
            public void sessionDestroyed(HttpSessionEvent event) {
                ...
                System.out.println("세션 만료 : " + LocalDateTime.now()
                        + "session : " + event.getSession().getId());
            }
            ...
            public void sessionIdChanged(HttpSessionEvent event, String oldSessionId) {
                ...
                System.out.println("세션 변경 : " + LocalDateTime.now()
                        + "old session : " + oldSessionId + "new session : " + event.getSession().getId());
