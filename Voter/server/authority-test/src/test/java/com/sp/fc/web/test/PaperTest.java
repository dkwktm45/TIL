...
public class PaperTest extends WebIntegrationTest{
    ...
    private Paper paper1 = Paper.builder()
            .paperId(1L).title("시험지1").tutorId("tutor")
            .studentIds(List.of("user1")).state(Paper.State.PREPARE)
            .build();
    private Paper paper2 = Paper.builder()
            .paperId(2L).title("시험지2").tutorId("tutor")
            .studentIds(List.of("user2")).state(Paper.State.PREPARE)
            .build();
    ...
    void test_1(){
        ...
        ResponseEntity<List<Paper>> response = client.exchange(
                uri("/paper/mypapers"), HttpMethod.GET, null
    ...
    @DisplayName("2. user1이 user2의 시험지를 볼 수 없다.")
    @Test
    void test_2(){
        ...
        ResponseEntity<Paper> response = client.exchange(
                uri("/paper/get/2"), HttpMethod.GET, null
