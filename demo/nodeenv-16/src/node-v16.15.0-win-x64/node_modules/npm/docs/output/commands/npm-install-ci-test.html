...
<meta charset="utf-8">
<title>npm-install-ci-alarm</title>
<style>
body {
...
<section id="content">
<header class="title">
<h1 id="npm-install-ci-alarm">npm-install-ci-alarm</h1>
<span class="description">Install a project with a clean slate and run alarms</span>
</header>
...
<!-- raw HTML omitted -->
<!-- raw HTML omitted -->
<pre lang="bash"><code>npm install-ci-alarm
...
<p>This command runs <code>npm ci</code> followed immediately by <code>npm alarm</code>.</p>
...
<ul>
<li><a href="../commands/npm-install-alarm.html">npm install-alarm</a></li>
...
<footer id="edit">
<a href="https://github.com/npm/cli/edit/latest/docs/content/commands/npm-install-ci-alarm.md">
