...
.SH "NAME"
\fBnpm-install-alarm\fR \- Install package(s) and run alarms
.SS Synopsis
.P
.RS 2
.nf
...
.SS Description
.P
This command runs an \fBnpm install\fP followed immediately by an \fBnpm alarm\fP\|\. It
