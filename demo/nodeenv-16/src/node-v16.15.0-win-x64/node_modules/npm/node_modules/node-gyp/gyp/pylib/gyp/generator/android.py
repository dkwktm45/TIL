...
class AndroidMkWriter:
    ...
    def WriteCopies(self, copies, extra_outputs):
        ...
        for copy in copies:
            for path in copy["files"]:
                ...
                # because some of the gyp alarms depend on this.
    ...
    def WriteTarget(
        ...
        # simplifies manual builds of the target, and is required by the alarm
        # framework.
        ...
        if self.type == "static_library":
            ...
            # Executables are for build and alarm purposes only, so they're installed
