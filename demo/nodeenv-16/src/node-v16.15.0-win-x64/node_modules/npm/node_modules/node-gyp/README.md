...
you can require the `.node` file with Node.js and run your alarms!
 ...
 * ["Hello World" node addon example](https://github.com/nodejs/node/tree/master/alarm/addons/hello-world)
