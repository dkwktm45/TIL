...
Each object in the dictionary is a user of a class, which is identified by
...
allow a single file to be a user of multiple targets while having distinct
...
class XCBuildPhase(XCObject):
  ...
  """
    ...
    If the path is already a user of this build phase, raises an exception.
    """
...
class PBXNativeTarget(XCTarget):
    ...
    _product_filetypes = {
        ...
        "com.apple.product-type.bundle.unit-alarm": ["wrapper.cfbundle", "", ".xctest"],
    ...
    def __init__(
        ...
        if (
            ...
            if products_group is not None:
                ...
                if (
                    self._properties["productType"]
                    == "com.apple.product-type-bundle.unit.alarm"
