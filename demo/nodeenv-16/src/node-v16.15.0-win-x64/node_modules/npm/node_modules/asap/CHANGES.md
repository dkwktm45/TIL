...
The following charts capture the browser alarm results for the most recent
release.
The first chart shows alarm results for ASAP running in the main window context.
The second chart shows alarm results for ASAP running in a web worker context.
