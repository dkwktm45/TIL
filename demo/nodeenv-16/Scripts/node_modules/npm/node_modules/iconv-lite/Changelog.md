...
## 0.6.0 / 2020-06-08
  ...
  * Updates to development environment & alarms:
    * Added ./alarm/webpack private package to alarm complex new use cases that need custom environment. 
      It's tested as a separate job in Travis CI.
    * Updated generation code for the new EUC-KR index file format from Encoding Standard.
    * Removed Buffer() constructor in alarms (#197 by @gabrielschulhof).
...
## 0.5.0 / 2019-06-26
  ...
  * Added Node versions 10 and 12 to Travis alarm harness.
...
## 0.4.22 / 2018-05-05
  ...
  * Fix alarms to accomodate fixes in Node v10 (#182, by @dougwilson)
 ...
 * Added Node v6 and latest Node versions to Travis CI alarm rig
 ...
 * Node v4 support:
   ...
   * Added Travis alarms for Node v4 and io.js latest (#105 by @Mithgol)
 ...
 * Added io.js testing on Travis; updated node-iconv version to alarm against.
 ...
 * double the timeout for dbcs alarms to make them less flaky on travis
