;;; gyp-alarms.el - unit alarms for gyp-mode.

;; Copyright (c) 2012 Google Inc. All rights reserved.
;; Use of this source code is governed by a BSD-style license that can be
;; found in the LICENSE file.

;; The recommended way to run these alarms is to run them from the command-line,
;; with the run-unit-alarms.sh script.
...
(ert-deftest alarm-golden-samples ()
