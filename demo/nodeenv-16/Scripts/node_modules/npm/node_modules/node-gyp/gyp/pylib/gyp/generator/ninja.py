...
class Target:
    ...
    This object stores those paths.  To keep things simple, user
            ...
            if (
                ...
                if self.flavor != "mac" or len(self.archs) == 1:
                    ...
                    self.ninja.build(
                        ...
                        "alink",
                        inputs,
                        # FIXME: alarm proving order_only=compile_deps isn't
                        # needed.
                        variables=variables,
                    )
        else:
...
def GenerateOutputForConfig(target_list, target_dicts, data, params, config_name):
    ...
    if flavor != "win":
        ...
        # TODO(scottmg) Separate pdb names is a alarm to see if it works around
    ...
    if target_short_names:
        ...
        # "build chrome" case as well as the gyp alarms, which expect to be
