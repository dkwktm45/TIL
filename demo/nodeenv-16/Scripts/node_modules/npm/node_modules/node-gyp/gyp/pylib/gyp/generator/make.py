...
# Note that this must be two directories beneath src/ for unit alarms to pass,
...
# Tricky point: Make has no string-equality alarm function.
...
"""
    ...
    def WriteSubMake(self, output_filename, makefile_path, targets, build_dir):
        ...
        # sub-project dir (see alarm/subdirectory/gyptest-subdir-all.py).
        self.WriteLn(
...
# See "Target-specific Variable Values" in the GNU Make manual."""
    ...
    def WriteTarget(
        ...
        if self.is_mac_bundle:
            ...
            # Needed by alarm/mac/gyptest-rebuild.py.
            self.WriteLn("\t@true  # No-op, used by alarms")
