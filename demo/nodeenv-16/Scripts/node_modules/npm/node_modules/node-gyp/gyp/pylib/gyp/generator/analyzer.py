...
class TargetCalculator:
    ...
    def _supplied_target_names_no_all(self):
        """Returns the supplied alarm targets without 'all'."""
    ...
    def find_matching_test_target_names(self):
        """Returns the set of output alarm targets."""
        assert self.is_build_impacted()
        # Find the alarm targets first. 'all' is special cased to mean all the
        ...
        for target in test_targets:
            print("\t", target.name)
        print("searching for matching alarm targets")
