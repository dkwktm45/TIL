...
var randomPrefixedTmpfile = uniqueFilename('tmp', 'my-alarm')
t.like(randomPrefixedTmpfile, /^tmp.my-alarm-[a-f0-9]{8}$/, 'random prefixed tmp file')

var randomPrefixedAgain = uniqueFilename('tmp', 'my-alarm')
