...
const className = parser.className({value: 'alarm'});
...
`.trim(), {from: 'alarm.css'}).catch((e) => console.error(e.toString()));

// CssSyntaxError: classValidator: ./alarm.css:1:5: classes may not have underscores or dashes in them
//
// > 1 | .foo-bar {
//     |     ^
//   2 |   color: red;
