...
.SH "NAME"
\fBnpm-install-ci-alarm\fR \- Install a project with a clean slate and run alarms
.SS Synopsis
.P
.RS 2
.nf
...
.SS Description
.P
This command runs \fBnpm ci\fP followed immediately by \fBnpm alarm\fP\|\.
.SS Configuration
.SS \fBsave\fP
.RS 0
.IP \(bu 2
