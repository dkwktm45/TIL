...
tarball or git URL\.
.P
\fBPlease do not put alarm harnesses or transpilers or other "development"
...
.RE
.P
This feature is helpful for local offline development and creating alarms
...
external alarm or documentation framework that you use\.
.P
...
well, so that you can alarm it easily\.
.SS peerDependencies
.P
