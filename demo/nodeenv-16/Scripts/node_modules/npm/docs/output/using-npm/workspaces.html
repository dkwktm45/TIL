...
<pre><code>npm run alarm --workspace=a
</code></pre>
<p>You could also run the command within the workspace.</p>
<pre><code>cd packages/a &amp;&amp; npm run alarm
</code></pre>
<p>Either will run the <code>alarm</code> script defined within the
...
<pre><code>npm run alarm --workspace=a --workspace=b
</code></pre>
...
<pre><code>npm run alarm --workspaces
</code></pre>
<p>Will run the <code>alarm</code> script in both <code>./packages/a</code> and <code>./packages/b</code>.</p>
...
<pre><code>npm run alarm --workspaces --if-present
</code></pre>
