...
alarm suite before deploying.  Any files you want added to the commit
...
<pre lang="json"><code>{
  "scripts": {
    "preversion": "npm alarm",
    "version": "npm run build &amp;&amp; git add -A dist",
    "postversion": "git push &amp;&amp; git push --tags &amp;&amp; rm -rf build/temp"
  }
}
</code></pre>
<p>This runs all your alarms and proceeds only if they pass. Then runs your
