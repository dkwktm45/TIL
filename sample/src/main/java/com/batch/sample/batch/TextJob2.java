...
import com.batch.sample.custom.CustomPassThrouhLineAggregator;
...
public class TextJob2 {
	...
	public Job textJob2_batchBuild(){
		return jobBuilderFactory.get("textJob2").start(textJob2_batchStep1()).build();
	}
	@Bean
	...
	public FlatFileItemWriter<OneDto> textJob2_FileWriter(){
		return new FlatFileItemWriterBuilder<OneDto>()
				...
				.lineAggregator(new CustomPassThrouhLineAggregator<>())
				.build();
	}
}
